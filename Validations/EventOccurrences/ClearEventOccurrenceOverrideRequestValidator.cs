...
{
    public class ClearEventOccurrenceOverrideRequestValidator : AbstractValidator<ClearEventOccurrenceOverrideRequest>
    {
        public ClearEventOccurrenceOverrideRequestValidator()
        {
